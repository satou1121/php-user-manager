  ...
  <body>
    ...
    <table class="table table-striped">
      ...
      <tbody>
        ...
        <tr>
        <tb><?php echo $users['user_id']; ?></tb>
        <td>
          <a href="detail.php?user_id=<?php echo $users['user_id']; ?>">
          <?php echo $users['user_name']; ?>
          </a>
          </td>
        <td><?php echo data[ "Y/m/d H時i分"];  $users['create_dt']; ?></td>
        <td><?php echo $users['updata_dt']; ?></td>
        </tr>
        <?php }?>
      </tbody>
    </table>
